...
exec $mss_config_loc -CONFIGURATION_FILE:$local_dir/script_support/mss/Aldec_MSSv2.cfg -OUTPUT_DIR:$local_dir/script_support/components/MSS_eMMC
import_mss_component -file "$local_dir/script_support/mss/Aldec_MSSv2.cxz"
