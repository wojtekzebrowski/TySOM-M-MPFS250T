...
organize_tool_files -tool {PLACEROUTE} -file "${project_dir}/constraint/io/io.pdc" -file "${project_dir}/constraint/io/ALDEC_DDR4.pdc" -file "${project_dir}/constraint/fp/CCC.pdc" -module {tysom_m_v10::work} -input_type {constraint} 
