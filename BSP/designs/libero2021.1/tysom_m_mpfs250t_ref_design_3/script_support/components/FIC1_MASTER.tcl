# Exporting Component Description of FIC1_MASTER to TCL
# Family: PolarFireSoC
# Part Number: MPFS250T_ES-1FCG1152E
# Create and Configure the core component FIC1_MASTER
create_and_configure_core -core_vlnv {Actel:DirectCore:COREAXI4INTERCONNECT:2.8.103} -component_name {FIC1_MASTER} -params {\
"ADDR_WIDTH:32"  \
"CROSSBAR_MODE:0"  \
"DATA_WIDTH:64"  \
...
"USER_WIDTH:1"   }
# Exporting Component Description of FIC1_MASTER to TCL done
