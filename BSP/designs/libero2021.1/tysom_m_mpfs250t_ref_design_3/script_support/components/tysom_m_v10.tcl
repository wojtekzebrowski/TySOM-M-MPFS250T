...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSSv2_0:FIC_1_DLL_LOCK_M2F" "AND4_0:B" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSSv2_0:MSS_RESET_N_M2F" "RESET_CLK_62_5MHz_0:EXT_RST_N" "RESET_CLK_125MHz_0:EXT_RST_N" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSSv2_0:FIC_3_PCLK" "CLK_125MHz_to_CLK_62_5MHz_0:CLK_OUT" "RECONFIGURATION_INTERFACE_0:PCLK" "RESET_CLK_62_5MHz_0:CLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLK_160MHz_to_CLK_80MHz_0:CLK_OUT" "GLITCHLESS_MUX_0:CLK0" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"TRANSMIT_PLL_0:REF_CLK" "PCIE_REF_CLK_0:REF_CLK" "PF_PCIE_C0_0:PCIESS_LANE1_CDR_REF_CLK_0" "PF_PCIE_C0_0:PCIESS_LANE2_CDR_REF_CLK_0" "PF_PCIE_C0_0:PCIESS_LANE3_CDR_REF_CLK_0" "PF_PCIE_C0_0:PCIESS_LANE0_CDR_REF_CLK_0" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"PCIe_LOCK:B" "PFSOC_INIT_MONITOR_C0_0:PCIE_INIT_DONE" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESET_CLK_62_5MHz_0:PLL_POWERDOWN_B" "PF_CCC_C1_0:PLL_POWERDOWN_N_0" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC0_MASTER_IC_0:ACLK" "CLK_125MHz_to_CLK_62_5MHz_0:CLK_IN" "FIC1_MASTER_0:ACLK" "GLITCHLESS_MUX_0:CLK1" "PCIE_MASTER_0:ACLK" "RESET_CLK_125MHz_0:CLK" "TRANSMIT_PLL_0:CLK_125" "PF_PCIE_C0_0:AXI_CLK" "Aldec_MSSv2_0:FIC_2_ACLK" "Aldec_MSSv2_0:FIC_1_ACLK" "Aldec_MSSv2_0:FIC_0_ACLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"PCIe_LOCK:A" "SYSTEM_PLL_LOCK:A" "TRANSMIT_PLL_0:PLL_LOCK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC0_MASTER_IC_0:ARESETN" "FIC1_MASTER_0:ARESETN" "PCIE_MASTER_0:ARESETN" "PF_DDR4_C0_0:SYS_RESET_N" "RESET_CLK_125MHz_0:FABRIC_RESET_N" "PF_PCIE_C0_0:AXI_CLK_STABLE" "Aldec_MSSv2_0:MSS_RESET_N_F2M" "VSC_8662_RESETN" "USB_ULPI_RESET" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSSv2_0:FIC_3_APB_MASTER" "FIC3_MASTER_0:APB3mmaster" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"PF_PCIE_C0_0:AXI_1_MASTER" "PCIE_MASTER_0:AXI4mmaster0" }
